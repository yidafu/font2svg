...
inline fun CoroutineRouterSupport.createTaskRoute(vertx: Vertx): Router =
      ...
      post("/")
        ...
        .coHandler { ctx ->
          ...
          generator.use {
            ...
            val task =
              FontTask(createDTO.fontFamily, fontFile.length(), allCharList.size, 0, tempFilepath, FontTaskStatus.Created, face.id!!)
