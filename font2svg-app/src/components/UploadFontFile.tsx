...
export const UploadFontFile = forwardRef<HTMLDivElement>(function (props: IUploadFontFileProps & UseFormRegisterReturn<'fontUrl'>, uploadRef) {
    ...
    if (files.length > 0) {
      ...
      if (fontFile) {
        try {
          ...
          const evt = { target: { value: res.url, name: props.name }, type: 'change' }
