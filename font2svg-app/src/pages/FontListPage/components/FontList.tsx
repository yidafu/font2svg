...
export function FontList(props: IFontListProps) {
  ...
  const fetchFontList = useCallback(async function fetchFontList() {
              ...
              <Tr key={fontFace.id}>
                ...
                <Td>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => props.onSelect(fontFace.id)}
                  >
                    详情
                  </Button>
                  <Button
                    onClick={() => handleFontRemove(fontFace.id)}
                    variant="ghost"
                    size="sm"
                    colorScheme="red"
                  >
